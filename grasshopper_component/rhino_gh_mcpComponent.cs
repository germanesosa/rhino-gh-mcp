...
{
    public class rhino_gh_mcpComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public rhino_gh_mcpComponent()
          : base("rhino_gh_mcp MCP Server", "MCPServer",
            "Grasshopper MCP server and command bridge (C# port)",
            "MCP", "Server")
        {
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                using (var stream = assembly.GetManifestResourceStream("rhino_gh_mcp.Resources.IconForThisComponent.png"))
                {
                    if (stream != null)
